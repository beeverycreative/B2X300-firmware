 ...
 */
  ...
  #error "FILAMENT_CHANGE_EXTRUDE_FEEDRATE is now BEEVC_ADVANCED_PAUSE_EXTRUDE_FEEDRATE. Please update your configuration."
#elif defined(FILAMENT_CHANGE_EXTRUDE_LENGTH)
  #error "FILAMENT_CHANGE_EXTRUDE_LENGTH is now BEEVC_ADVANCED_PAUSE_EXTRUDE_LENGTH. Please update your configuration."
