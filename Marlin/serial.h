...
#define SERIAL_ECHO_BIN8(x)            {SERIAL_PROTOCOL((x & 0b10000000) == 0b10000000);SERIAL_PROTOCOL((x & 0b01000000) == 0b01000000);SERIAL_PROTOCOL((x & 0b00100000) == 0b00100000);SERIAL_PROTOCOL((x & 0b00010000) == 0b00010000);SERIAL_PROTOCOL((x & 0b00001000) == 0b00001000);SERIAL_PROTOCOL((x & 0b00000100) == 0b00000100);SERIAL_PROTOCOL((x & 0b00000010) == 0b00000010);SERIAL_PROTOCOL((x & 0b00000001) == 0b00000001);}	
